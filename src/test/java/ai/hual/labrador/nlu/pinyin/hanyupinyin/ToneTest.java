...
public class ToneTest {
    ...
    /**
     * Test method for {@link Tone#Tone(int)}.
     */
    @Test
    ...
    /**
     * Test method for {@link Tone#getMode()}.
     */
    @Test
    public void testGetMode() {

        // true enum by definition, but just in case there are typos...
        assertTrue(Tone.TONE_NUMBERS.getMode() == 1);
        assertTrue(Tone.TONES_OFF.getMode() == 2);
        assertTrue(Tone.TONE_MARKS.getMode() == 3);
